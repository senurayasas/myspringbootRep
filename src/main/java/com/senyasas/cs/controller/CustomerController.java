...
public class CustomerController {
    ...
    @DeleteMapping("/{id}")
    public CustomerModel delete(@PathVariable final Long id) {
        log.info(String.format("deleting customer id with %s", id));
        final var customerToDelete = repository.findById(id)
